...
const stages = [
  {
    num: "01",
    tag: "СИНХРОНИЗАЦИЯ",
    description: "Деконструкция рыночной логики и настройка терминала под NAS100.",
  },
  {
    num: "02",
    tag: "ПРОЕКТИРОВАНИЕ",
    description: "Создание индивидуального торгового алгоритма без участия эмоций.",
  },
  {
    num: "03",
    tag: "AI_VALIDATION",
    description: "Жесткая проверка стратегии через ИИ-бектест. Допуск к следующему этапу только при подтвержденной статистике.",
  },
  {
    num: "04",
    tag: "КОРРЕКЦИЯ",
    description: "Живая торговля и работа с менторами в режиме реального времени.",
  },
  {
    num: "05",
    tag: "ГАРАНТИЯ РЕЗУЛЬТАТА",
    description: "Если по итогам обучения цель не достигнута — активируется протокол индивидуального сопровождения. Личные созвоны с ментором до полной стабилизации твоей торговли.",
    highlighted: true,
  },
  {
    num: "06",
    tag: "КАПИТАЛИЗАЦИЯ",
    description: "Выход на Prop-фондирование и получение капитала от $50,000.",
  },
];
              ...
              >
                ...
                <div
                  className={`glass rounded-sm p-6 transition-all duration-300 ${
                    stage.highlighted ? "stage-guarantee-glow" : ""
                  }`}
                >
                  {/* Header */}
                  <div className="flex items-start justify-between gap-4 mb-3">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="font-mono text-sm md:text-base font-medium text-foreground">
                        {stage.tag}
                      </h3>
                    </div>
                    ...
                    {stage.highlighted && (
                      <div className="flex items-center gap-2 px-3 py-1 rounded-sm border border-primary/30 bg-primary/5 pulse-cyan-strong shrink-0">
                        ...
                        <span className="font-mono text-[10px] tracking-wider cyan-text">
                          IMPORTANT
                        </span>
                      </div>
                    )}
