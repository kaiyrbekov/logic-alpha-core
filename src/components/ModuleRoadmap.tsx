...
const modules = [
  { num: "01", title: "Профессиональная перспектива", description: "Честный разбор механики рынка и ответ на вопрос, почему трейдинг останется актуальной профессией навсегда. Узнаешь, откуда берутся деньги в сделках и как выстроить путь к первому системному профиту." },
